...
<body>
    <section class=" bg-center dark:bg-white bg-repeat-x bg-clip-content bg-auto" style="background-image: url('https://i.pinimg.com/474x/8e/10/66/8e1066c598b9176569a5e03906261140.jpg')">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 ">
            <div class="w-full rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 bg-transparent" >
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form action="{{ route('register') }}" method="POST">
                        ...
                        <button a href="" type="submit"
                            class="w-full text-black bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-black dark:hover:bg-primary-700 dark:focus:ring-primary-800">Create
                            an account</button>
