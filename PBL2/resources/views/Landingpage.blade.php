...
<header class="flex flex-wrap  md:justify-start md:flex-nowrap z-50 w-full bg-white border-b border-gray-200 dark:bg-neutral-800 dark:border-neutral-700">
  <nav class="relative max-w-[85rem] w-full mx-auto flex items-center justify-between gap-3 py-2 px-4 sm:px-6 lg:px-8">
    ...
    <a class="flex-none font-semibold text-xl text-black focus:outline-none focus:opacity-80 dark:text-white" href="{{ route('Home') }}" aria-label="Brand" >SIARIS</a>
...
<section class="bg-white dark:bg-gray-900">
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
            <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl text-black">Apa Oleh Oleh Biasa Anda Beli?</h1>
        ...
        <div class="hidden lg:mt-0 lg:col-span-5 lg:flex sm:block sm:basis-56 aspect-square h-full w-full object-cover">
            <img src="https://i.pinimg.com/736x/ee/92/25/ee922583d3606be28a730ece6ae0dbf8.jpg"  alt="mockup" >
        </div>
    </div>
</section>
